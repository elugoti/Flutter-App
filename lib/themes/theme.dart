...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(display1: TextStyle(color: LightColor.white)),
    iconTheme: IconThemeData(color: LightColor.iconColor),
    bottomAppBarColor: LightColor.background,
    dividerColor: LightColor.lightGrey,
    primaryTextTheme: TextTheme(
      body1: TextStyle(color:LightColor.white)
    )
  );

  static TextStyle titleStyle = const TextStyle(color: LightColor.white, fontSize: 16);
